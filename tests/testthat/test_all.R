...
test_that("check MSPC pipeline", {
    ...
    expect_equivalent(len, list(97, 132,219))
    ...
    expect_equivalent(len_confER, list(86, 180,200))
    ...
    expect_equivalent(len_disc, list(11, 26,104))
})
